...
window.GameBoyAdvanceSoftwareRenderer = class GameBoyAdvanceSoftwareRenderer {
	constructor() {
		this.LAYER_BG0 = 0;
		this.LAYER_BG1 = 1;
		this.LAYER_BG2 = 2;
		...
		this.drawBackdrop = this.createDrawBackdropFunction.bind(this);
	}
	clear(mmu) {
	...
	createDrawBackdropFunction(video) {
		this.bg = true;
		this.priority = -1;
